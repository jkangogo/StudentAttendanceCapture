package com.kangogo.attendancesystem.bean;
...
public class StudentBean {
	...
	private String student_fingerprint;
	...
	public String getStudent_fingerprint() {
		return student_fingerprint;
	}
	public void setStudent_fingerprint(String student_fingerprint) {
		this.student_fingerprint = student_fingerprint;
	}
