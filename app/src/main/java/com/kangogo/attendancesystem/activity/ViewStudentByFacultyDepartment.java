...
public class ViewStudentByFacultyDepartment extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		studentBeanList=dbAdapter.getAllStudentByFacultyDepartment(faculty, department);
		...
		listView.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
				...
				AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(ViewStudentByFacultyDepartment.this);
