package com.kangogo.attendancesystem.db;
...
public class DBAdapter extends SQLiteOpenHelper {
	...
	private static final String KEY_STUDENT_FINGERPRINT = "student_fingerprint";
	...
	public void addStudent(StudentBean studentBean) {
		...
		String query = "INSERT INTO student_table (student_firstname,student_lastname,student_mobilenumber,student_address,student_department,student_class,student_fingerprint) values ('"+
				...
				studentBean.getStudent_fingerprint()+"')";
	...
	public ArrayList<StudentBean> getAllStudent()
	{
		...
		if(cursor.moveToFirst())
		{
			do{
				...
				studentBean.setStudent_fingerprint(cursor.getString(7));
	...
	public ArrayList<StudentBean> getAllStudentByFacultyDepartment(String faculty,String department)
	{
		ArrayList<StudentBean> list = new ArrayList<StudentBean>();

		SQLiteDatabase db = this.getWritableDatabase();
		String query = "SELECT * FROM student_table where student_department='"+faculty+"' and student_class='"+department+"'";
		Cursor cursor = db.rawQuery(query, null);
	...
	public ArrayList<AttendanceBean> getAllAttendanceByStudent()
	{
		...
		SQLiteDatabase db = this.getWritableDatabase();
		String query = "SELECT attendance_student_id,count(*) FROM attendance_table where attendance_status='attended' group by attendance_student_id";
